...
<body>
    ...
    <header class="header-main">
        <div class="header-main-logo">
            ...
            <nav class="header-main-topNav">
                <ul>
                    ...
                    <li><a href="navBar1.html"><img src="./farmer_item_pic/home_icon.png"></a></li>
        ...
        <a href="../process_logout/logout.php" style="display: flex; flex-direction: column; margin-left: -37vw; margin-top: -6px;">
