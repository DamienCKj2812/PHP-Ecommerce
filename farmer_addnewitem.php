...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_FILES["video_button"]) && $_FILES["video_button"]["error"] === UPLOAD_ERR_OK) {
        $targetDir = "uploads/";
        $targetFile = $targetDir . basename($_FILES["video_button"]["name"]);

        if (move_uploaded_file($_FILES["video_button"]["tmp_name"], $targetFile)) {
    ...
    if (isset($_POST["userid"])) {
        ...
        $sql = "INSERT INTO product (coverPhoto, image1, video_button, product_name, product_description, product_price, product_stock, product_weight, userid) 
                VALUES ('$coverPhotoPath', '$image1Path', '$videoPath', '$product_name', '$product_description', '$product_price', '$product_stock', '$product_weight', '$tempUserId')";
...
<body>
    ...
    <header class="header-main">
        ...
        <a href="./logout.php" style="display: flex; flex-direction: column; margin-left: -37vw; margin-top: -6px;">
            <img src="./farmer_item_pic/logout.png" style="width: 50px; margin-top: 25px;">
            <p style="margin-top: 1px; margin-left: 5px; color: white; font-size: 13px; font-family: Arial, Helvetica, sans-serif;">Logout</p>
        </a>
...
<!-- Content of right frame -->
            <div class="content-frame">
                ...
                <div class="product-weight-container">
                    <div class="productprice-word">*Weight (kg)</div> 
                ...
                <input type="hidden" name="userid" value="<?php echo $tempUserId;?>">
